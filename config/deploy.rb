...
GITHUB_REPOSITORY_NAME = 'bendyworks/lobsters'
LINODE_SERVER_HOSTNAME = '72.14.183.103'
...
set :application,                "makemadison"
set :deploy_to,                  "/var/www/apps/makemadison"
...
after 'deploy:update_code' do
  ...
  run "cp #{shared_path}/config/credentials.rb #{release_path}/config/credentials.rb"
